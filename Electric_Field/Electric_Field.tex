...
where the fact that $\sin 45^\circ=\cos 45^\circ=1/\sqrt{2}$ was used. The magnitude is $E=k|q$1|/8a^2$.
...
Charge $q$1$ is at $(x,y)=(a, a)$. Find the magnitude of the electric field, $E$, at $(x,y)=(0, 0)$ using the above formula and then find $\bfvec{E}$ in the form $\bfvec{E}=E$x\ihat + E$y\jhat$.
